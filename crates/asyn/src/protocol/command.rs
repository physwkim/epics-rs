...
mod tests {
    ...
    fn serde_roundtrip_all_variants() {
        let commands = vec![
            ...
            PortCommand::OctetWrite { data: vec![1, 2, 3] },
            PortCommand::OctetWriteRead { data: vec![4, 5], buf_size: 128 },
            PortCommand::UInt32DigitalRead { mask: 0xFF },
            PortCommand::UInt32DigitalWrite { value: 0xAB, mask: 0xFF },
            PortCommand::EnumRead,
            PortCommand::EnumWrite { index: 2 },
            PortCommand::Int32ArrayRead { max_elements: 100 },
            PortCommand::Int32ArrayWrite { data: vec![1, 2, 3] },
            PortCommand::Float64ArrayRead { max_elements: 50 },
            PortCommand::Float64ArrayWrite { data: vec![1.0, 2.0] },
            PortCommand::Flush,
            PortCommand::Connect,
