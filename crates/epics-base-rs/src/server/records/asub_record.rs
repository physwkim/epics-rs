...
pub struct ASubRecord {
    ...
    // Output arrays
    pub vala: Vec<f64>, pub valb: Vec<f64>, pub valc: Vec<f64>, pub vald: Vec<f64>,
    pub vale: Vec<f64>, pub valf: Vec<f64>, pub valg: Vec<f64>, pub valh: Vec<f64>,
    pub vali: Vec<f64>, pub valj: Vec<f64>, pub valk: Vec<f64>, pub vall: Vec<f64>,
    // Output links
    pub outa: String, pub outb: String, pub outc: String, pub outd: String,
    pub oute: String, pub outf: String, pub outg: String, pub outh: String,
    pub outi: String, pub outj: String, pub outk: String, pub outl: String,
    // Array sizes (NOA-NOL for inputs, NOVA-NOVL for outputs)
    pub noa: i32, pub nob: i32, pub noc: i32, pub nod: i32,
    pub noe: i32, pub nof: i32, pub nog: i32, pub noh: i32,
    pub noi: i32, pub noj: i32, pub nok: i32, pub nol: i32,
    pub nova: i32, pub novb: i32, pub novc: i32, pub novd: i32,
    pub nove: i32, pub novf: i32, pub novg: i32, pub novh: i32,
    pub novi: i32, pub novj: i32, pub novk: i32, pub novl: i32,
}

impl Default for ASubRecord {
    fn default() -> Self {
        Self {
            val: 0.0, snam: String::new(), inam: String::new(),
            ...
            vala: Vec::new(), valb: Vec::new(), valc: Vec::new(), vald: Vec::new(),
            vale: Vec::new(), valf: Vec::new(), valg: Vec::new(), valh: Vec::new(),
            vali: Vec::new(), valj: Vec::new(), valk: Vec::new(), vall: Vec::new(),
            ...
            outi: String::new(), outj: String::new(), outk: String::new(), outl: String::new(),
            noa: 1, nob: 1, noc: 1, nod: 1, noe: 1, nof: 1,
            nog: 1, noh: 1, noi: 1, noj: 1, nok: 1, nol: 1,
            nova: 1, novb: 1, novc: 1, novd: 1, nove: 1, novf: 1,
            novg: 1, novh: 1, novi: 1, novj: 1, novk: 1, novl: 1,
        }
    }
}
...
static ASUB_FIELDS: &[FieldDesc] = &[
    ...
    FieldDesc { name: "SNAM", dbf_type: DbFieldType::String, read_only: false },
    FieldDesc { name: "INAM", dbf_type: DbFieldType::String, read_only: false },
    // Input links
    ...
    FieldDesc { name: "VALA", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALB", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALC", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALD", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALE", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALF", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALG", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALH", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALI", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALJ", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALK", dbf_type: DbFieldType::Double, read_only: false },
    FieldDesc { name: "VALL", dbf_type: DbFieldType::Double, read_only: false },
    // Output links
    ...
    // Array sizes
    FieldDesc { name: "NOA", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOB", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOC", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOD", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOE", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOF", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOG", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOH", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOI", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOJ", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOK", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOL", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVA", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVB", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVC", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVD", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVE", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVF", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVG", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVH", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVI", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVJ", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVK", dbf_type: DbFieldType::Long, read_only: false },
    FieldDesc { name: "NOVL", dbf_type: DbFieldType::Long, read_only: false },
];
...
impl Record for ASubRecord {
    fn record_type(&self) -> &'static str { "aSub" }
    ...
    fn put_field(&mut self, name: &str, value: EpicsValue) -> CaResult<()> {
        match name {
            "VAL" => { self.val = value.to_f64().ok_or_else(|| CaError::TypeMismatch(name.into()))?; Ok(()) }
            "SNAM" => match value { EpicsValue::String(s) => { self.snam = s; Ok(()) } _ => Err(CaError::TypeMismatch(name.into())) }
            "INAM" => match value { EpicsValue::String(s) => { self.inam = s; Ok(()) } _ => Err(CaError::TypeMismatch(name.into())) }
            // Input links
            "INPA" | "INPB" | "INPC" | "INPD" | "INPE" | "INPF" |
            "INPG" | "INPH" | "INPI" | "INPJ" | "INPK" | "INPL" => {
                let s = match value { EpicsValue::String(s) => s, _ => return Err(CaError::TypeMismatch(name.into())) };
                match name {
                    "INPA" => self.inpa = s, "INPB" => self.inpb = s, "INPC" => self.inpc = s,
                    "INPD" => self.inpd = s, "INPE" => self.inpe = s, "INPF" => self.inpf = s,
                    "INPG" => self.inpg = s, "INPH" => self.inph = s, "INPI" => self.inpi = s,
                    "INPJ" => self.inpj = s, "INPK" => self.inpk = s, "INPL" => self.inpl = s,
                    _ => unreachable!(),
                }
                Ok(())
            }
            ...
            "VALG" | "VALH" | "VALI" | "VALJ" | "VALK" | "VALL" => {
                let arr = match value {
                    ...
                    other => vec![other.to_f64().ok_or_else(|| CaError::TypeMismatch(name.into()))?],
                };
                match name {
                    "VALA" => self.vala = arr, "VALB" => self.valb = arr, "VALC" => self.valc = arr,
                    "VALD" => self.vald = arr, "VALE" => self.vale = arr, "VALF" => self.valf = arr,
                    "VALG" => self.valg = arr, "VALH" => self.valh = arr, "VALI" => self.vali = arr,
                    "VALJ" => self.valj = arr, "VALK" => self.valk = arr, "VALL" => self.vall = arr,
                    _ => unreachable!(),
                }
                Ok(())
            }
            ...
            "OUTG" | "OUTH" | "OUTI" | "OUTJ" | "OUTK" | "OUTL" => {
                let s = match value { EpicsValue::String(s) => s, _ => return Err(CaError::TypeMismatch(name.into())) };
                match name {
                    "OUTA" => self.outa = s, "OUTB" => self.outb = s, "OUTC" => self.outc = s,
                    "OUTD" => self.outd = s, "OUTE" => self.oute = s, "OUTF" => self.outf = s,
                    "OUTG" => self.outg = s, "OUTH" => self.outh = s, "OUTI" => self.outi = s,
                    "OUTJ" => self.outj = s, "OUTK" => self.outk = s, "OUTL" => self.outl = s,
                    _ => unreachable!(),
                }
                Ok(())
            }
            ...
            n if n.starts_with("NO") => {
                ...
                match name {
                    "NOA" => self.noa = v, "NOB" => self.nob = v, "NOC" => self.noc = v,
                    "NOD" => self.nod = v, "NOE" => self.noe = v, "NOF" => self.nof = v,
                    "NOG" => self.nog = v, "NOH" => self.noh = v, "NOI" => self.noi = v,
                    "NOJ" => self.noj = v, "NOK" => self.nok = v, "NOL" => self.nol = v,
                    "NOVA" => self.nova = v, "NOVB" => self.novb = v, "NOVC" => self.novc = v,
                    "NOVD" => self.novd = v, "NOVE" => self.nove = v, "NOVF" => self.novf = v,
                    "NOVG" => self.novg = v, "NOVH" => self.novh = v, "NOVI" => self.novi = v,
                    "NOVJ" => self.novj = v, "NOVK" => self.novk = v, "NOVL" => self.novl = v,
    ...
    fn field_list(&self) -> &'static [FieldDesc] { ASUB_FIELDS }
