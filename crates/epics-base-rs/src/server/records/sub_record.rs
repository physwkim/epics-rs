...
impl Record for SubRecord {
    ...
    fn put_field(&mut self, name: &str, value: EpicsValue) -> CaResult<()> {
        match name {
            ...
            "SNAM" => match value { EpicsValue::String(s) => { self.snam = s; Ok(()) } _ => Err(CaError::TypeMismatch("SNAM".into())) },
    ...
    fn field_list(&self) -> &'static [FieldDesc] { SUB_FIELDS }
