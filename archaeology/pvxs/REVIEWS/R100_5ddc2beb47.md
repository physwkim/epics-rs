# R100 — 5ddc2beb475f [LOW][applies]

**Subject**: server monitor throttle using send queue size  
**Date**: 2020-01-26  
**pvxs SHA**: 5ddc2beb475f  
...
## Diff
```diff
commit 5ddc2beb475f951aad111f67507a2f99994bfb30
Author: Michael Davidsaver <mdavidsaver@gmail.com>
Date:   Sun Jan 26 15:55:56 2020 -0800
...
@@ -447,16 +447,33 @@ void ServerConn::bevRead()
...
--- a/src/serverconn.h
+++ b/src/serverconn.h
@@ -112,8 +112,10 @@ struct ServerConn : public std::enable_shared_from_this<ServerConn>
...
--- a/src/servermon.cpp
+++ b/src/servermon.cpp
@@ -58,13 +58,28 @@ struct MonitorOp : public ServerOp,
