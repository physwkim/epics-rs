# R022 — 2f4484889186 [MEDIUM][applies]

**Subject**: server: handle monitor created without initial ACK  
**Date**: 2025-01-31  
**pvxs SHA**: 2f4484889186  
...
## Diff
```diff
commit 2f4484889186acca8ff5f1306e9ab5270f3969a8
Author: Michael Davidsaver <mdavidsaver@gmail.com>
Date:   Fri Jan 31 21:41:31 2025 -0800
...
--- a/src/servermon.cpp
+++ b/src/servermon.cpp
@@ -500,52 +500,75 @@ void ServerConn::handle_MONITOR()
         }
         chan->statRx += rxlen;
